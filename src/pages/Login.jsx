...
export default function Login() {
  const { login, loading, demoMode } = useAuth();
  ...
  // Demo buttons log in immediately without requiring form submit
        ...
        <div className={styles.formBox}>
          ...
          {demoMode && (
            <div className={styles.infoBanner}>
              <span>ℹ️</span> Running in demo mode — no backend required
            </div>
          )}
          ...
          {/* Demo quick-login — logs in immediately */}
          <div className={styles.demoRow}>
            <button
              className={styles.demoBtn}
              disabled={loading}
              onClick={() => handleDemo('student@gmail.com', 'student123')}
            >
              👤 Use Student Demo
            </button>
            <button
              className={styles.demoBtn}
              disabled={loading}
              onClick={() => handleDemo('admin@gmail.com', 'admin123')}
            >
              ⚙️ Use Admin Demo
            </button>
          </div>
